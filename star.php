<?php  if (isset($country) && $country == "ES" || strpos($timezone, "Europe")) { $proxy = "https://slowdus.herokuapp.com/"; echo "Estás usando proxy en" . $country; } else { $proxy = ""; echo "No estás usando proxy en " .$country; } ?>
