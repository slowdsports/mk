...
if (isset($country) && $country == "ES" || strpos($timezone, "rope")) {
    ...
    echo "<h4 class='subtitle'>Estás usando proxy en " . $timezone . ". Si crees que es un error, contáctanos mediante el chat</h4>";
} else {
    $proxy = "";
    echo "<h4 class='subtitle'>No estás usando proxy en " . $timezone . ". Si crees que es un error, contáctanos mediante el chat</h4>";
}
?>
