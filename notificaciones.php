<div class="error-page">
    ...
    <h1 class="title">¡En Proceso!</h1>
    <div class="text mb-3">
        Esta sección está en construcción, estará disponible muy pronto.
    </div>
    <div class="fixed-footer">
        <div class="row">
            <div class="col-12">
                <a href="javascript:history.back()" class="btn btn-primary btn-lg btn-block">Go Back</a>
            </div>
        </div>
    </div>
</div>